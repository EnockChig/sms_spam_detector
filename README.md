...
gradio_sms_text_classification.ipynb: This notebook contains the Gradio interface setup and the function for SMS classification.
...
The main function, sms_classification, is implemented in gradio_sms_text_classification.ipynb. It uses the SMSSpamCollection.csv dataset to classify SMS text messages as either "ham" (not spam) or "spam".
